...
import ConstructImageSrc from './ConstructImageSrc';
    ...
    <div className='card'>
      ...
      <div className='card-body'>
        {grouping === 'status' ? null : (
          <img src={ConstructImageSrc('status',ticket.status)} alt={`Status: ${ticket.status}`} />
        )}
      ...
      <div className='card-footer'>
        {grouping === 'priority' ? null : (
          <div className='card-footer-priority'>
            <img src={ConstructImageSrc('priority',ticket.priority)}
